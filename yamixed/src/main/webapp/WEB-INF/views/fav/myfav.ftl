	...
	<div id="articleDiv">
		...
		<div class="media">
			...
			<ul class="pager">
				<#if (pageNum>0)>
				<li class="previous">
					<a href="${rc.getContextPath()}/fav/userfav/${channel.id}/${loginUser.id}/${tagid}/${pageNum-1}/${tags.number}/40" title="上一页链接">上一页</a>
				</li>
				</#if>
				<#if (pageNum<pages)>
				<li class="next">
					<a href="${rc.getContextPath()}/fav/userfav/${channel.id}/${loginUser.id}/${tagid}/${pageNum+1}/${tags.number}/40" title="下一页链接">下一页</a>
				</li>
				</#if>
			</ul>
			</#if>
