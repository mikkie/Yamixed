...
<body>
	<div>
		...
		<ul class="pager">
			<#if (tags.number>0)>
			<li class="previous">
				<a href="${rc.getContextPath()}/fav/${channel.id}/${tags.number-1}/40" title="上一页标签">&laquo;</a>
			</li>
			</#if>
			<#if (tags.number<tags.totalPages-1)>
			<li class="next">
				<a href="${rc.getContextPath()}/fav/${channel.id}/${tags.number+1}/40" title="下一页标签">&raquo;</a>
			</li>
			</#if>
		</ul>	
	</div>	
